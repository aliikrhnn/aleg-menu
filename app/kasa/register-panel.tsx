...
function RegisterContent({
  ...
  // Realtime subscribe - yeni çağrı geldiğinde anlık güncelle
  useEffect(() => {
    if (!businessId) return;
    const supabase = createClient();
    const channel = supabase
      .channel('waiter_calls_kasa')
      .on(
        'postgres_changes',
        {
          event: 'INSERT',
          ...
          <div className="flex items-center gap-2">
            ...
            {activeCalls.length > 0 && (
              ...
              >
                ...
                {/* Sürekli ping efekti - dikkat çekme */}
                <span
