...
export function WhatsAppFloat() {
  const message = encodeURIComponent('Merhaba, Aleg hakkında bilgi almak istiyorum.');
  ...
  return (
    <a
      ...
      className="fixed bottom-7 right-7 z-[90] w-[58px] h-[58px] rounded-full bg-accent text-paper grid place-items-center hover:opacity-90 transition-opacity"
      style={{
