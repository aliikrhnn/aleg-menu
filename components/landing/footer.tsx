...
const COLUMNS = [
  {
    h: 'Ürün',
    links: ['Özellikler', 'Fiyatlar', 'Modüller', 'Yenilikler', 'Yol Haritası'],
  },
            ...
            <div className="flex gap-2.5">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={s.name}
                  className="w-8 h-8 rounded-full grid place-items-center hover:bg-paper hover:text-ink transition-all"
                  style={{
